<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>  <!-- c로 시작하는 콜론 사용 jstl 반복해서 여러개 찍어줌 -->
	...
	<div class="container-fluid">
		...
		<div>
			<table border="1" class="table table-sm">
				...
				<tbody>  <!-- var="item" 속성 item  =items=${list} 변수명list  컨트롤러에서 가져옴 el로 불로와 출력-->
